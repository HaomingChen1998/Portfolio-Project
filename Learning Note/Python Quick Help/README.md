...
python -m venv .venv # Creating new environment: .venv can be change to the name you want the new virtual environment to be.
C:\> <venv>\Scripts/activate.bat # to activate this new virtual environment.
